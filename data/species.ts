...
export const species: Species[] = [
  {
    ...
    nameEs: 'Lucio',
    image: '/brochet.png',
    description: "Le prédateur des eaux froides, redoutable chasseur tapi dans les herbiers.",
    descriptionEn: "The cold-water predator, a formidable hunter lurking in weed beds.",
    descriptionEs: "El depredador de las aguas frías, un formidable cazador entre los carrizales.",
  ...
  },
  {
    ...
    nameEs: 'Black Bass',
    image: '/blackbass.png',
    description: "Champion du combat aquatique, star des pêches sportives d'Extremadura.",
    descriptionEn: "Champion of aquatic combat, star of Extremadura's sport fishing.",
    descriptionEs: "Campeón del combate acuático, estrella de la pesca deportiva en Extremadura.",
